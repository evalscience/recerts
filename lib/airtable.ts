...
export async function fetchAllAirtableRecordsForDebug(): Promise<AirtableRecord[]> {
...
export async function fetchApprovedHypercertIdsFromAirtable(): Promise<string[]> {
