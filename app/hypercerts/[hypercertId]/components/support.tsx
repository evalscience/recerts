...
const BuyFraction = ({ text }: { text: string }) => {
  return (
    <div className="w-full flex flex-col items-center bg-background border border-border rounded-xl px-8 py-4">
        ...
        {hypercert.sales?.map((sale) => {
          ...
          return (
            <li
              ...
              className="border border-border rounded-2xl px-4 py-2 flex items-center justify-between"
            >
